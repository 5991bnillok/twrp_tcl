...
TARGET_BOOTLOADER_BOARD_NAME := MT6761     # From ro.product.board
...
DEVICE_RESOLUTION := 720x1560                 # The Resolution of your Device
TARGET_SCREEN_HEIGHT := 1560                    # The height
TARGET_SCREEN_WIDTH := 720                      # The width
TARGET_RECOVERY_PIXEL_FORMAT := "RGBA_8888"
# Set the Brightness Control File Path below (as per your chip/device)
TW_BRIGHTNESS_PATH := /sys/class/leds/lcd-backlight/brightness
#TW_SECONDARY_BRIGHTNESS_PATH := /sys/devices/platform/leds-mt6761/leds/lcd-backlight/brightness
